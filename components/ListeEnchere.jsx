        ...
        <div>
            <section class="bg-light">
                ...
                <div class="col-lg-6 m-auto">
                    <h1 class="h1">Liste des enchères</h1>
                    </div>
            </div>
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gridColumnGap: "100px", gridRowGap: "100px", height: "100vh" }}>
                {encheres.map((e) =>
                
                <div style={{ background: "lightblue" }}>
                    <div class="card h-100">
                        <a href={`/listeEncheres/${e.idEnchere}`} className="text-decoration-none text-dark">
                        ...
                        <div class="card-body">
                            <ul class="list-unstyled d-flex justify-content-between">
                                ...
                                <li class="text-muted text-right">{e.prix_min_enchere} ar</li>
                            </ul>
                            <a href={`/listeEncheres/${e.idEnchere}`} class="h2 text-decoration-none text-dark">{e.produit.nomProduit}</a>
                            <p class="card-text">
                                {e.description}
                            </p>
                        </div>
